      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <input
            ...
            name="title"
            placeholder="Title"
            className="w-full rounded-lg bg-gray-50 p-2 placeholder:text-gray-800 dark:bg-dark-background_card_textfield dark:text-white dark:placeholder:text-white"
