  ...
  return (
    <div className="font-[Poppins] p-4 px-16 bg-white ">
      <div className="flex justify-start items-center mb-4">
        ...
        <h2 className="text-sm md:text-xl lg:text-2xl font-bold ml-4">
          Create Post
        </h2>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4 flex items-center  flex-col md:flex-row ">
          <label className="md:block font-semibold mb-2 md:mb-0  md:mr-8 w-full md:w-fit flex items-center justify-start ">
            Categories
          </label>
          <div className="flex flex-wrap md:gap-x-2 gap-2 items-center justify-center md:justify-start w-full ">
        ...
        <div className="w-full  flex items-center justify-center">
          <button
            type="submit"
            className="bg-black  text-white p-2 rounded-lg hover:bg-gray-800 flex items-center justify-center"
          >
            Create Blog
          </button>
        </div>
