        ...
        <form onSubmit={handleSubmit} className="sm:w-5/6 lg:w-2/3">
          ...
          <div className="mb-4 flex justify-between gap-2 sm:gap-4">
            ...
            <button
              name="openModal"
              type="button"
              className="lg:text-sm active:scale-click w-1/4 rounded-lg bg-light-primary text-xs text-slate-50 hover:bg-light-primary/80 dark:bg-dark-primary dark:text-dark-card dark:hover:bg-dark-secondary/80 sm:text-sm lg:w-2/12 lg:px-4 lg:py-3"
              onClick={() => {
                setmodal(true);
              }}
            >
