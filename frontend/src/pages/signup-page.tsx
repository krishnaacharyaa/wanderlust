...
function signup() {
  ...
  return (
    <div className="bg-white dark:bg-neutral-700">
      <div className="m-4 flex-grow cursor-default py-4">
        <div className="mb-4 flex justify-center">
          <div className="flex w-full items-center justify-center">
            <h2 className="w-3/4 pl-52 text-center text-lg font-bold text-black dark:text-light sm:text-xl">
        ...
        <div className="m-2 mt-8 flex flex-col items-center justify-center gap-2">
          <form onSubmit={handleSubmit(onSubmit)} className="w-full md:w-3/4 lg:w-2/5">
            <div className="mb-3">
              <input
                ...
                className="w-full rounded-lg bg-zinc-100 p-3 font-normal placeholder:text-sm placeholder:text-neutral-500 dark:bg-zinc-800 dark:text-light"
              />
              {errors.userName && (
            ...
            <button
              ...
              type="submit"
              className="flex w-full items-center justify-center rounded-lg bg-neutral-800 p-3 text-base font-medium text-light disabled:bg-neutral-600 dark:bg-light dark:text-black sm:text-lg sm:font-semibold"
            >
              Sign Up
            </button>
          </form>
          <div className="mt-2 flex w-5/6 flex-col items-center justify-center gap-4 text-center text-sm font-normal dark:text-light sm:text-base">
            <p>
          ...
          <Link
            to={'/google-auth'}
            className="flex w-full items-center justify-center space-x-2 rounded-lg border-2 border-b-4 border-gray-300 p-3 text-center hover:bg-gray-50 dark:text-light dark:hover:bg-gray-800 md:w-3/4 lg:w-2/5"
          >
            <img className="h-4 w-6 pl-1 sm:h-5 sm:w-10" src={AddGoogleIcon} />
            <span className="text-sm dark:text-light sm:text-base">Continue with Google</span>
          </Link>
          ...
          >
            ...
            <span className="text-sm dark:text-light sm:text-base">Continue with Github</span>
          </Link>
        </div>
      </div>
    </div>
