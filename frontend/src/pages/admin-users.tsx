    ...
    <>
      <div className="w-full p-3 px-5 sm:p-12">
        ...
        <div className="mt-2 sm:mt-12">
          <div className="flex  w-full  flex-row items-center justify-between   gap-5 rounded-lg border-b border-gray-300 bg-light px-3 py-4 shadow-sm dark:border-gray-700 dark:bg-dark-card">
