	...
	return (
		<div className='font-[Poppins] w-full'>
				...
				<div className='absolute inset-0 flex flex-col px-16 py-8 text-white'>
					...
					<div className='flex flex-1 flex-col justify-end pb-8 max-w-5xl'>
						...
						<p className='text-xl my-4'>
							Dive into the World of Travel with Stories That Transport You to Far-Off Lands. Adventure awaits around every
							corner. It's time to explore the world!
						</p>
			...
			<div className='px-16 py-6'>
				<BlogFeed />
				<h1 className='text-2xl font-semibold mb-4'>All Blog Posts</h1>
