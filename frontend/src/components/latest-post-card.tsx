...
export default function LatestPostCard({ post }: { post: Post }) {
  ...
  return (
    <div
      className="bg-white rounded-lg py-2 shadow-sm cursor-pointer p-2 dark:bg-gray-500 dark:text-white"
      onClick={() => navigate('/details-page', { state: { post } })}
    >
      <div className="flex">
        <div className="flex flex-wrap mb-2 flex-1 gap-2 dark:text-black">
